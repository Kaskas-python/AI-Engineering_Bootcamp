...
def check_warehouse_availability(items: list[dict]) -> dict:
    ...
    Args:
        items: A list of dicts to check. Each dict must have keys:
...
def reserve_warehouse_items(reservations: list[dict]) -> dict:
    ...
    Args:
        reservations: A list of dicts. Each dict must have keys:
                     - warehouse_id (str): the warehouse to reserve from
                     - product_id (str): the product to reserve
